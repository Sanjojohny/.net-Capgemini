...
namespace LINQ_Assignment_BoilerPlateCode
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            List<Employee> objEmp = GetHighEarningEmployees(employees);
        ...
        static List<Employee> GetHighEarningEmployees(List<Employee> employees)
        {
			...
			var result = employees.Where(p => p.Salary > 60000).ToList();
...

        {
			List<Employee> res = new List<Employee>();
			// TODO: Write LINQ query here
			var result = employees.Select(p => p.Name).ToList();
            foreach(var item in result)
            {
                result.Add(item);
            }
        ...
        {
            var result = employees.Any(p => p.Department == "HR");
            throw new NotImplementedException();
        }
        ...
        static List<DepartmentCount> GetDepartmentWiseCount(List<Employee> employees)
        {
			...
			var result = employees.GroupBy(e => e.Department).Select(g => new  { Department = g.Key, Count = g.Count() }).ToList();
        ...
        {
            // TODO: Write LINQ query here
            var result=employees.Max(p => p.Salary);
            throw new NotImplementedException();
        }
        ...
        {
            // TODO: Write LINQ query here
            var res = employees.OrderByDescending(p => p.Salary).ThenBy(p => p.Name).ToList();
            throw new NotImplementedException();
        }
        ...
        {
            // TODO: Write LINQ query here
            var res = employees.Where(p => !projects.Any(a => a.ProjectId == p.Id)).ToList();
            throw new NotImplementedException();
        }
        ...
        {
            // TODO: Write LINQ query here
            var result = employees.Select(a => a.Skills).Distinct().ToList();
            throw new NotImplementedException();
        }
        ...
        {
            // TODO: Write LINQ query here
            var res=employees.GroupBy(a=>a.Department).Select(p=>new {Department=p.Key,TopEmpployee=employees.OrderByDescending(g=>g.Salary).Take(3).ToList()});
            throw new NotImplementedException();
        }
